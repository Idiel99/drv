// Three.js wireframe building scene for the hero
window.initHeroScene = function (canvas) {
  ...
  camera.lookAt(6, 5, 0); // bias view to the right so left side is open for text
  ...
  group.position.x = 4; // push cluster to the right of the frame
  scene.add(group);
  ...
  // Plane wash under the grid for fade
